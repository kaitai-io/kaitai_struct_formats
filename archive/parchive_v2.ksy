    ...
    seq:
      ...
      - id: body
        ...
        type:
          ...
          cases:
            '"PAR 2.0\0Main\0\0\0\0"': main
            '"PAR 2.0\0PkdMain\0"': packed_main
            '"PAR 2.0\0RecvSlic"': recovery_slice
            '"PAR 2.0\0PkdRecvS"': packed_recovery_slice
            '"PAR 2.0\0FileDesc"': file_descriptor
            '"PAR 2.0\0IFSC\0\0\0\0"': input_file_slice_checksum
            '"PAR 2.0\0Creator\0"': creator
            '"PAR 2.0\0UniFileN"': unicode_filename
            '"PAR 2.0\0CommASCI"': ascii_comment
            '"PAR 2.0\0CommUni"': unicode_comment
            '"PAR 2.0\0FileSlic"': input_file_slice
            '"PAR 2.0\0RFSC\0\0\0\0"': recovery_file_slice_checksum
            #'"NewsPostUsenet\0\0"': example_news_post
    types:
      preheader:
        seq:
          - id: signature
