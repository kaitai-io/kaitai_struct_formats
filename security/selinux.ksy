meta:
  ...
  endian: le
doc-ref: |
  https://github.com/SELinuxProject/selinux/blob/master/libsepol/src/policydb.c
  https://github.com/SELinuxProject/selinux/blob/master/libsepol/src/write.c
seq:
  - id: header
    type: header
...
types:
  header: # policydb_read
    ...
    - id: magic
      ...
      enum: magics
      valid:
        expr: '(magic == magics::kernel) or (magic == magics::module)'
    - id: policydb_str_len
      -orig-id: len
      type: u4
    - id: policydb_str
