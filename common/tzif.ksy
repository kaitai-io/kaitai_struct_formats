    ...
    seq:
      ...
      - id: leap_second_records
        ...
        doc: |
          ...
          record, if present, MUST have a non-negative occurrence time and MUST
          have a correction value of either negative one (-1) or one (1). Each
          succeeding leap-second record MUST have an occurrence time at least
