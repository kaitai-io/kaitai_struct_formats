meta:
  id: checksum_simple_xor_u4
  license: Unlicense
  title: Computes a simple XOR checksum
  endian: le
doc: |
...
instances:
  ...
  value:
    value: reduction[data.size - 1].res & 0xFFFFFFFF
types:
  iteration:
    params:
      - id: idx
    ...
    instances:
      prev:
        value: "idx == 0 ? _root.initial : (_parent.reduction[idx - 1].as<iteration>.res).as<u4>"
      res:
