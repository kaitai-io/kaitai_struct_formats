...
doc: |
  ...
  s = SpiderSav.from_file("./spider.sav")  # https://github.com/kaitai-io/kaitai_struct_formats/files/6118058/spider.zip
...
instances:
  ...
  initial_prg_state:
    pos: 0
    type: prg_lcg(0x343fd, 0x269ec3, 16, 15, prg_seed)  # Visual C++ rand
  #decks:
  #  type: card(_index)
  #  repeat: expr
  #  repeat-expr: total
