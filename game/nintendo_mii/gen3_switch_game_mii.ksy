...
seq:
  ...
  - id: mii_name
    ...
    doc: |
      ...
      Different from the Mii name that appears in Super Smash Bros. Ultimate - in that game, this is never seen.
  - id: font_region
    type: u1
    repeat: expr
    repeat-expr: 3
  ...
  - id: eyebrow_stretch
    ...
    doc: |
      Eyebrow stretch.
      Ranges from 0 to 6, small to large.
  - id: eyebrow_rotation
    type: u1
    doc: |
      Eyebrow rotation.
      Ranges from 0 to 11, down to up.
  ...
  - id: eyebrow_vertical
    ...
    doc: |
      ...
      Ranges from 18 to 3, low to high.
  - id: nose_type
    type: u1
    doc: |
      Nose type. Ranges from 0 to 17.
      Not ordered the same as visible in editor.
  - id: nose_size
    type: u1
    doc: |
