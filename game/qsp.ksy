...
instances:
  is_new_format:
    value: true
  locations_count:
    value: "(is_new_format?locations_count_str.as<rot5_number_str>.number:locations_count_str.as<number_str>.number)"
types:
  string_placeholder:
    doc: |
  ...
  rot5_str:
    ...
    doc: According to the official docks it allows to put multiple lines into a single line.
    seq:
      - id: placeholder
        type: string_placeholder
    instances:
  ...
  loc:
    ...
    instances:
      actions_count:
        value: "(_root.is_new_format?actions_count_new.as<rot5_number_str>.number:20)"
    types:
      act:
  ...
  game_state:
    ...
    instances:
      cur_actions_count:
        value: _root.is_new_format?cur_actions_count_new.number:20
    types:
      index:
        seq:
          - id: index
